...
if (!function_exists('cambridgesleepsciences_pagination')) {
     ...
     */
    function cambridgesleepsciences_pagination($args = array(), $class = 'pagination nav') {
	...
	$args = wp_parse_args(
	    ...
	    'mid_size' => 2,
	    'prev_next' => true,
	    'prev_text' => __('Previous page', 'cambridgesleepsciences'),
	    'next_text' => __('Next Page', 'cambridgesleepsciences'),
	    'type' => 'array',
	    'current' => max(1, get_query_var('paged')),
	    'screen_reader_text' => __('Posts navigation', 'cambridgesleepsciences'),
		)
	);
